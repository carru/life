...
class Controls {
    ...
    set boardWidth(boardWidth) {
        if (boardWidth > 0) {
            ...
            jquery_1.default("#board-width").val(boardWidth);
        }
    }
    get boardHeight() {
    ...
    set renderer(renderer) {
        ...
        jquery_1.default("#start-renderer-btn").on("click", () => this._renderer.start());
        jquery_1.default("#stop-renderer-btn").on("click", () => this._renderer.stop());
    }
    get simulationLoop() {
    ...
    set simulationLoop(simulationLoop) {
        ...
        jquery_1.default("#start-simulation-btn").on("click", () => this._simulationLoop.start());
        jquery_1.default("#stop-simulation-btn").on("click", () => this._simulationLoop.stop());
        jquery_1.default("#simulation-speed-1-btn").on("click", () => this.updateSpeed(SimulationLoop_1.SimulationSpeed.NORMAL));
        jquery_1.default("#simulation-speed-2-btn").on("click", () => this.updateSpeed(SimulationLoop_1.SimulationSpeed.FAST));
        jquery_1.default("#simulation-speed-3-btn").on("click", () => this.updateSpeed(SimulationLoop_1.SimulationSpeed.FASTER));
        jquery_1.default("#simulation-speed-4-btn").on("click", () => this.updateSpeed(SimulationLoop_1.SimulationSpeed.LUDICROUS));
    }
    toggle() {
    ...
    updateBoardSize() {
        this._boardWidth = Number(jquery_1.default("#board-width").val());
        this._boardHeight = Number(jquery_1.default("#board-height").val());
